  ...
  const routerConfig = {
    ...
    '/performance/index': {
      component: dynamicWrapper(app, ['performance'], () =>
        import ('../routes/A_performance/index')),
    },
    '/order/index': {
      component: dynamicWrapper(app, ['order'], () =>
        import ('../routes/A_order/index')),
    },
    '/order/index2': {
      component: dynamicWrapper(app, ['order'], () =>
        import ('../routes/A_order/index2')),
    },
    '/order/index3': {
      component: dynamicWrapper(app, ['order'], () =>
        import ('../routes/A_order/index3')),
    },
